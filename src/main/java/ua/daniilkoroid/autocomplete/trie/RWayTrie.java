...
public class RWayTrie implements Trie {
	 ...
	 * 
	 * @param node
	 *            parent node to find node with given key among parent node
	 *            children
	 * @param key
	 *            key to find node by
	 * @param d
	 *            number of char in key to currently watch for
	 ...
	 * <p>
	 * If given node is not correct for putting given tuple in - tries to put given tuple in appropriate child of given node.
	 * </p>
	 * @param node node to put given tuple in or parent (can be indirect) of node to put given tuple in 
